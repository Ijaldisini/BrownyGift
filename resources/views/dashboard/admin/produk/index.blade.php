                ...
                <table class="w-full">
                    ...
                    <tbody class="bg-white divide-y divide-pink-100">
                        ...
                        <tr class="hover:bg-gradient-to-r hover:from-pink-50 hover:to-rose-50 transition-all duration-200">
                            ...
                            <td class="px-6 py-4">
                                <span class="block max-w-xs truncate text-gray-600" title="{{ $product->deskripsi_produk }}">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center space-x-2">
                                    ...
                                    <span class="font-bold text-gray-900">{{ $product->stok_produk }}</span>
                                </div>
                            </td>
                            <td class="px-6 py-4">
                                ...
                                <!-- Delete Modal -->
                                <div id="deleteModal{{ $product->id_produk }}" class="hidden fixed inset-0 bg-gray-900 bg-opacity-50 overflow-y-auto h-full w-full z-50 flex items-center justify-center">
                                    <div class="relative p-8 border border-pink-200 w-full max-w-md shadow-2xl rounded-2xl bg-white mx-4 animate-slideDown">
                                        ...
                                        <div class="py-6">
                                            ...
                                            <div class="bg-gradient-to-r from-pink-50 to-rose-50 p-4 rounded-xl border border-pink-200">
                                                <strong class="text-gray-900 font-bold">{{ $product->nama_produk }}</strong>
                                            </div>
                                        </div>
                        ...
                        <tr>
                            <td colspan="7" class="text-center py-16">
                                <div class="flex flex-col items-center">
                                    ...
                                    <a href="{{ route('admin.produk.create') }}" class="text-pink-600 hover:text-pink-700 font-bold hover:underline inline-flex items-center">
