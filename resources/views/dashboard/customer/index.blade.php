        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-3 sidebar">
                    ...
                    <a href="{{ route('customer.index') }}" class="active"><i class="fas fa-home"></i> Dashboard</a>
                ...
                <div class="col-md-9 main-content">
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-4">
                            <a href="{{ route('customer.produk') }}" class="menu-card">
                                <div>
                        ...
                        <div class="col-md-4 mb-4">
                            <a href="{{ route('customer.keranjang') }}" class="menu-card">
                                <div>
                        ...
                        <div class="col-md-4 mb-4">
                            <a href="{{ route('customer.pesanansaya') }}" class="menu-card">
                                <div>
