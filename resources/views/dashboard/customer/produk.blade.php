  ...
  <div class="row">
    ...
    <div class="col-md-9 main-content">
      ...
      <div class="product-grid" id="productGrid">
        ...
        <div class="product-card" data-category="{{ $product->kategori->nama_kategori ?? 'Umum' }}">
          <div class="product-image">
            {{-- Pengambilan gambar disesuaikan dengan folder 'images' dan fallback onerror --}}
          ...
          <div class="product-body">
            <div class="product-category">{{ $product->kategori->nama_kategori ?? 'Umum' }}</div>
