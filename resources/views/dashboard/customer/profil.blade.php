    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-3 sidebar">
                ...
                <a href="{{ route('customer.profil') }}" class="active"><i class="fas fa-user"></i> Profil Saya</a>
                    ...
                    <div class="row align-items-center">
                        <div class="col-auto">
                            <div class="profile-photo">
                                @if(auth()->user()->photo)
                                <img src="{{ asset('storage/' . auth()->user()->photo) }}" alt="Profile Photo" style="width: 100%; height: 100%; object-fit: cover; border-radius: 50%;">
                                @else
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="card h-100 border-0 shadow-sm" style="background: #fffafa;">
                                <div class="card-body">
                                    <h6 class="fw-bold">{{ $address->nama_penerima }} <small class="text-muted">({{ $address->no_hp_penerima }})</small></h6>
                                    <p class="mb-2 text-muted small">
                                        {{ $address->detail_alamat }}<br>
                                        {{ $address->desa->nama_desa }}, {{ $address->kecamatan->nama_kecamatan }}
                                    </p>
                                    <div class="text-end">
                                        <form action="{{ route('customer.address.delete', $address->id_alamat) }}" method="POST" onsubmit="return confirm('Hapus alamat ini?');">
                                            @csrf
                                            @method('DELETE')
