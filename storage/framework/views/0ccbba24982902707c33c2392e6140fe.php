...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-3 sidebar">
            ...
            <a href="<?php echo e(route('customer.riwayat')); ?>" class="active"><i class="fas fa-history"></i> Riwayat Belanja</a>
        ...
        <div class="col-md-9 main-content">
                ...
                <div class="stat-card stat-card-pink">
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <div class="stat-value" id="totalOrders"><?php echo e($orders->count()); ?></div>
                        </div>
                        <div class="stat-icon">
                    ...
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <div class="stat-value" id="pendingOrders">
                                <?php echo e($orders->whereIn('id_status_pemesanan', [1, 2])->count()); ?>
                    ...
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <div class="stat-value" id="processingOrders">
                                <?php echo e($orders->whereIn('id_status_pemesanan', [3, 4])->count()); ?>
                    ...
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <div class="stat-value" id="completedOrders">
                                <?php echo e($orders->whereIn('id_status_pemesanan', [5])->count()); ?>
            ...
            <div class="history-container" id="historyContainer">
                <div class="table-responsive" style="<?php echo e($orders->isEmpty() ? 'display: none;' : ''); ?>">
                    <table class="history-table">
                        ...
                        <tbody id="historyTableBody">
                            ...
                            <tr data-status="<?php echo e(strtolower($order->statusPemesanan->status_pemesanan ?? 'unknown')); ?>">
                                ...
                                <td>
                                    <div class="product-info">
                                        <?php $__currentLoopData = $order->detailPesanan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <span class="product-name"><?php echo e($detail->produk->nama_produk ?? 'Produk Dihapus'); ?> (x<?php echo e($detail->quantity_per_produk); ?>)</span>
                ...
                <div class="empty-history" id="emptyHistory" style="<?php echo e($orders->isEmpty() ? 'display: block;' : 'display: none;'); ?>">
...
<script>
    const ordersData = [
        <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        {
            ...
            rawStatus: '<?php echo e(ucfirst($order->statusPemesanan->status_pemesanan ?? "Unknown")); ?>',
            statusClass: (() => {
...
</html><?php /**PATH C:\laragon\www\PROJECTPWEB_K11\resources\views/dashboard/customer/riwayatbelanja.blade.php ENDPATH**/ ?>