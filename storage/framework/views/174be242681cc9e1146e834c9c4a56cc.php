    ...
    <?php echo e($persentasePerubahan >= 0 ? 'text-green-500' : 'text-red-500'); ?>">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
            <a href="/owner/profil_toko"
                class="group bg-white rounded-2xl shadow-sm p-8 hover:bg-pink-600 transition-all text-center">
                <div
                    class="w-16 h-16 bg-pink-100 group-hover:bg-white/20 rounded-2xl flex items-center justify-center mb-4 mx-auto transition-colors">
            ...
            <a href="/owner/karyawan_list"
                class="group bg-white rounded-2xl shadow-sm p-8 hover:bg-pink-700 transition-all text-center">
                <div
                    class="w-16 h-16 bg-blue-100 group-hover:bg-white/20 rounded-2xl flex items-center justify-center mb-4 mx-auto transition-colors">
            ...
            <a href="/owner/laporan_penjualan"
                class="group bg-white rounded-2xl shadow-sm p-8 hover:bg-pink-800 transition-all text-center">
                <div
                    class="w-16 h-16 bg-green-100 group-hover:bg-white/20 rounded-2xl flex items-center justify-center mb-4 mx-auto transition-colors">
