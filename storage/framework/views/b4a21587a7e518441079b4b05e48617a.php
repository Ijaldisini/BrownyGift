    ...
    <div class="bg-white rounded-3xl shadow-2xl overflow-hidden border border-pink-100">
            ...
            <div class="flex justify-between items-start">
                <div class="text-white">
                    ...
                    <div class="flex items-center space-x-3 bg-white/10 backdrop-blur-sm px-4 py-2 rounded-xl inline-flex">
                        ...
                        <span class="text-lg font-semibold">Pesanan #<?php echo e($pesanan->id_pesanan); ?></span>
                    </div>
                </div>
        ...
        <div class="p-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                ...
                <div class="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-blue-500 to-cyan-500 p-8 text-white shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
                    ...
                    <div class="relative">
                        ...
                        <p class="text-3xl font-bold"><?php echo e($pesanan->statusPemesanan->status_pemesanan); ?></p>
                    </div>
                </div>
                ...
                <div class="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-emerald-500 to-teal-500 p-8 text-white shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
                    ...
                    <div class="relative">
                        ...
                        <p class="text-3xl font-bold"><?php echo e($pesanan->statusPembayaran->status_pembayaran); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-gradient-to-br from-pink-50 via-rose-50 to-pink-50 rounded-2xl p-8 mb-8 border border-pink-200">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div class="group bg-white rounded-xl p-6 shadow-sm hover:shadow-lg transition-all duration-300 border border-pink-100 hover:border-pink-300">
                        ...
                        <p class="font-bold text-gray-900 text-lg"><?php echo e($pesanan->user->nama); ?></p>
                    </div>
                    ...
                    <div class="group bg-white rounded-xl p-6 shadow-sm hover:shadow-lg transition-all duration-300 border border-pink-100 hover:border-pink-300">
                        ...
                        <p class="font-bold text-gray-900 text-lg">
                            <?php echo e(\Carbon\Carbon::parse($pesanan->tanggal_pemesanan)->format('d M Y H:i')); ?>
                    ...
                    <div class="group bg-white rounded-xl p-6 shadow-sm hover:shadow-lg transition-all duration-300 border border-pink-100 hover:border-pink-300">
                        ...
                        <p class="font-bold text-gray-900 text-lg">
                            <?php echo e($pesanan->tanggal_pengambilan
            ...
            <div class="bg-gradient-to-br from-purple-50 via-fuchsia-50 to-purple-50 rounded-2xl p-8 mb-8 border border-purple-200">
                ...
                <div class="bg-white rounded-xl p-6 shadow-lg border border-purple-100">
                    <div class="flex justify-center">
                        <img src="<?php echo e(asset('images/bukti/' . $pesanan->bukti_pembayaran)); ?>"
            ...
            <div class="mb-8">
                ...
                <div class="space-y-4">
                    <?php $__currentLoopData = $pesanan->detailPesanan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="flex justify-between items-center">
                            <div class="flex items-center space-x-5">
                                ...
                                <div class="w-14 h-14 bg-gradient-to-br from-pink-500 to-rose-500 rounded-2xl flex items-center justify-center shadow-lg">
                                    <span class="text-white font-bold text-xl"><?php echo e($index + 1); ?></span>
                                </div>
                                ...
                                <!-- Product Info -->
                                <div>
                                    <p class="font-bold text-gray-900 text-xl mb-2"><?php echo e($item->produk->nama_produk); ?></p>
                                    <div class="flex items-center space-x-4 text-gray-600">
                                        <div class="flex items-center space-x-2 bg-pink-50 px-3 py-1 rounded-lg">
                                            <i class="bi bi-box text-pink-600"></i>
                                            <span class="font-semibold text-sm"><?php echo e($item->quantity_per_produk); ?> unit</span>
                                        </div>
                                        <div class="flex items-center space-x-2 bg-blue-50 px-3 py-1 rounded-lg">
                                            <i class="bi bi-tag text-blue-600"></i>
                                            <span class="font-semibold text-sm">Rp <?php echo e(number_format($item->harga_produk,0,',','.')); ?></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\COLLEGE LIFE\SEMESTER 3\PEMROGRAMAN WEBSITE\PROJECT\PROJECT NEW NEW\BrownyGift\resources\views/dashboard/admin/pesanan/show.blade.php ENDPATH**/ ?>