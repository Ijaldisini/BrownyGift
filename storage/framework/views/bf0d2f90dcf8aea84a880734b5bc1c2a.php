                ...
                <div class="p-6 relative">
                    ...
                    <div class="relative">
                        ...
                        <h3 class="text-3xl font-bold bg-gradient-to-r from-amber-600 to-orange-500 bg-clip-text text-transparent">
                            <?php echo e($orders->where('statusPembayaran.status_pembayaran', '!=', 'Lunas')->count()); ?>
                ...
                <div class="p-6 relative">
                    ...
                    <div class="relative">
                        ...
                        <h3 class="text-3xl font-bold bg-gradient-to-r from-blue-600 to-cyan-500 bg-clip-text text-transparent">
                            <?php echo e($orders->where('statusPemesanan.status_pemesanan', 'Diproses')->count()); ?>
                ...
                <div class="p-6 relative">
                    ...
                    <div class="relative">
                        ...
                        <h3 class="text-3xl font-bold bg-gradient-to-r from-emerald-600 to-teal-500 bg-clip-text text-transparent">
                            <?php echo e($orders->where('statusPemesanan.status_pemesanan', 'Selesai')->count()); ?>
                        ...
                        <tr class="hover:bg-gradient-to-r hover:from-pink-50 hover:to-rose-50 transition-all duration-200">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center space-x-2 text-gray-700">
                                    ...
                                    <span class="font-medium"><?php echo e(\Carbon\Carbon::parse($order->tanggal_pemesanan)->format('d M Y')); ?></span>
                                </div>
                            </td>
                            <td class="px-6 py-4">
                                <div class="flex items-center space-x-2">
                                    ...
                                    <span class="font-semibold text-gray-900"><?php echo e($order->user->nama); ?></span>
                                </div>
                            </td>
                            <td class="px-6 py-4">
                            ...
                            <!-- Status Pembayaran -->
                            <td class="px-6 py-4">
                                <form action="<?php echo e(route('admin.pesanan.updatePembayaran', $order->id_pesanan)); ?>" method="POST" class="inline-block">
                                    <?php echo csrf_field(); ?>
                                    ...
                                    <select name="status_pembayaran_id"
                                            ...
                                            <?php echo e($order->statusPembayaran->status_pembayaran == 'Lunas'
                                        ...
                                        <?php $__currentLoopData = $statusPembayaran; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($status->id_status_pembayaran); ?>"
                                                <?php echo e($order->id_status_pembayaran == $status->id_status_pembayaran ? 'selected' : ''); ?>>
                                                <?php echo e($status->status_pembayaran); ?>
                            ...
                            <td class="px-6 py-4">
                                <form action="<?php echo e(route('admin.pesanan.updateStatus', $order->id_pesanan)); ?>" method="POST" class="inline-block">
                                    ...
                                    <select name="status_pemesanan_id"
                                            ...
                                            <?php elseif($order->statusPemesanan->status_pemesanan == 'Selesai'): ?>
                                                bg-gradient-to-r from-emerald-50 to-teal-50 text-emerald-700 border-emerald-300 hover:border-emerald-400 focus:ring-emerald-500
                                            <?php else: ?>
                                                bg-gradient-to-r from-gray-50 to-slate-50 text-gray-700 border-gray-300 hover:border-gray-400 focus:ring-gray-500
                                            <?php endif; ?>">
                                        <?php $__currentLoopData = $statusPemesanan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($status->id_status_pemesanan); ?>"
                                                <?php echo e($order->id_status_pemesanan == $status->id_status_pemesanan ? 'selected' : ''); ?>>
                                                <?php echo e(ucfirst($status->status_pemesanan)); ?>
                            ...
                            <td class="px-6 py-4">
                                <a href="<?php echo e(route('admin.pesanan.show', $order->id_pesanan)); ?>"
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\COLLEGE LIFE\SEMESTER 3\PEMROGRAMAN WEBSITE\PROJECT\PROJECT NEW NEW\BrownyGift\resources\views/dashboard/admin/pesanan/index.blade.php ENDPATH**/ ?>